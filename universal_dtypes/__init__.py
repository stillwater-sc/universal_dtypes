...
- ``dd_cascade`` — double-double (~106-bit significand), a 16-byte high-precision
  type; multiply/divide/add use error-free transformations.
...
# high-precision cascades (multi-word storage); more arrive with #5/#6.
cascade_dtypes = {
